        ...
        <div className='grid mx-auto grid-cols-1 lg:grid-cols-4 mb-10 p-5'>
            {
                LearningGridArray.map((card, index) => {
                    return (
                        <div key={index}
                        className={`${index==0 && "lg:col-span-2 lg:h-[280px] p-8"}
                        ${card.order % 2 === 1 ? "bg-richblack-700 lg:h-[280px] p-8" : "bg-richblack-800 lg:h-[280px] p-8" }
                        ...
                        `}>
                            {
                                ...
                                : (
                                    <div className='flex flex-col gap-8 '>
                                        <h1 className='text-xl text-richblack-5'>{card.heading}</h1>
